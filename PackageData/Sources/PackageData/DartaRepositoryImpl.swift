...
public final class DartaRepositoryImpl: DartaRepository, @unchecked Sendable {
    ...
    public func login(email: String, password: String) async throws -> LoginEntity {
    ...
    public func getAccount(email: String) async throws -> AccountEntity {
    ...
    public func getLimits(email: String) async throws -> LimitsEntity {
    ...
    public func createWithdrawal(email: String, amountCents: Int) async throws -> TicketEntity {
    ...
    public func createValidateWithdrawal(qrPayload: String) async throws -> WithdrawalValidateEntity {
    ...
    public func dispense(qrPayload: String) async throws -> DispenseEntity {
