...
xcodebuild -project "$PROJECT_DIR/Darta.xcodeproj" -resolvePackageDependencies -quiet
...
SIMULATOR_ID=$(xcodebuild -showdestinations -project "$PROJECT_DIR/Darta.xcodeproj" -scheme DartaPresentationTest | \
...
xcodebuild test \
  -project "$PROJECT_DIR/Darta.xcodeproj" \
  -scheme DartaPresentationTest \
